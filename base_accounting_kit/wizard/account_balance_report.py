...
class AccountBalanceReport(models.TransientModel):
    ...
    name = fields.Char(
        string="Trial Balance", default="Trial Balance", required=True, translate=True
    )
    ...
    def _get_report_name(self):
        ...
        return self.env["consolidation.period"].browse(period_id)["display_name"] or _(
            "Trial Balance"
        )
    ...
    def _print_report(self, data):
        ...
        return self.env.ref(
            "base_accounting_kit.action_report_trial_balance"
