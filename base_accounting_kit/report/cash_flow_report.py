        ...
        for report in reports:
            ...
            if report.type == "accounts":
                ...
                for key, value in res2.items():
                    ...
                    if (
                        report == cash_in_operation
                        or report == cash_in_financial
                        or report == cash_in_investing
                    ):
                        res[report.id]["debit"] += value["debit"]
                        res[report.id]["balance"] += value["debit"]
                    elif (
                        report == cash_out_operation
                        or report == cash_out_financial
    ...
    def get_account_lines(self, data):
        ...
        for report in child_reports:
            vals = {
                ...
                and int(report.style_overwrite)
                or report.level,
