...
class AccountAgedTrialBalance(models.TransientModel):
    ...
    name = fields.Char(
        string="Account Aged Trial balance Report",
    ...
    period_length = fields.Integer(
        string="Period Length (days)", required=True, default=30
    )
    ...
    def _print_report(self, data):
        ...
        return (
            self.env.ref("base_accounting_kit.action_report_aged_partner_balance")
