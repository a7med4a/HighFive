        ...
        if data and report_action == "dynamic_accounts_report.action_partner_ledger":
            ...
            for partner in partners:
                ...
                total_debit = (
                    ...
                    if data["total"] and partner in data["total"]
                    else 0
                )
                total_credit = (
                ...
                sheet.merge_range(
                    row, col + 7, row, col + 8, format_number(total_debit), txt_name
                )
                sheet.merge_range(
                    row, col + 9, row, col + 10, format_number(total_credit), txt_name
                )
                sheet.merge_range(
                    row, col + 11, row, col + 12, format_number(balance), txt_name
                )
                ...
                if initial_balance != 0:
                    ...
                    sheet.write(row, col + 2, " ", txt_name)
                    sheet.merge_range(
                        row, col + 3, row, col + 4, "Initial Balance", head_highlight
                    )
                    sheet.merge_range(row, col + 5, row, col + 6, " ", txt_name)
                    sheet.merge_range(
                        row,
                ...
                for rec in data["data"][partner]:
                    ...
                    sheet.merge_range(
                        row, col + 3, row, col + 4, rec[0]["move_name"], txt_name
                    )
                    sheet.merge_range(
                        row,
                        col + 5,
            ...
            grand_total_debit = (
                ...
                if data["grand_total"]
                and data["grand_total"]["total_debit"] is not None
                else 0
            )
            grand_total_credit = (
                data["grand_total"]["total_credit"]
                if data["grand_total"]
                and data["grand_total"]["total_credit"] is not None
                else 0
            )
            ...
            sheet.merge_range(
                ...
                row,
                col + 8,
                format_number(grand_total_debit),
                filter_head,
            )
            sheet.merge_range(
                row,
                ...
                row,
                col + 10,
                format_number(grand_total_credit),
                filter_head,
            )
            sheet.merge_range(
                row, col + 11, row, col + 12, format_number(grand_balance), filter_head
            )
