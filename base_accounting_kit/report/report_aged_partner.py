...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def _get_partner_move_lines(
        ...
        for partner in partners:
            ...
            undue_amt = 0.0
            if (
                partner["partner_id"] in undue_amounts
            ...
            if partner["partner_id"]:
                ...
                values["name"] = (
                    browsed_partner.name
                    and len(browsed_partner.name) >= 45
                    and browsed_partner.name[0:40] + "..."
                    or browsed_partner.name
                )
