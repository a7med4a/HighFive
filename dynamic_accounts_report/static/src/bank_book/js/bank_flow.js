...
class BankBook extends owl.Component {
    ...
    async onSearchChange(ev) {
        ...
        let filtered_data = await this.orm.call("bank.book.report", "get_filter_values", [this.state.selected_partner, this.state.date_range, this.state.selected_account_list, this.state.options, this.state.search_value]);
