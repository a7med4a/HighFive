        ...
        if data:
            if report_action == "dynamic_accounts_report.action_aged_receivable":
                ...
                for move_line in data["move_lines"]:
                    ...
                    sheet.write(
                        row, col + 8, data["total"][move_line]["diff0_sum"], num_format
                    )
                    sheet.write(
                        row, col + 9, data["total"][move_line]["diff1_sum"], num_format
                    )
                    sheet.write(
                        row, col + 10, data["total"][move_line]["diff2_sum"], num_format
                    )
                    sheet.write(
                        row, col + 11, data["total"][move_line]["diff3_sum"], num_format
                    )
                    sheet.write(
                        row, col + 12, data["total"][move_line]["diff4_sum"], num_format
                    )
                    sheet.write(
                        row, col + 13, data["total"][move_line]["diff5_sum"], num_format
                    )
                    sheet.write(
                        row, col + 14, data["total"][move_line]["debit_sum"], num_format
                    )
                    for rec in data["data"][move_line]:
                        ...
                        sheet.write(row, col + 2, rec["amount_currency"], num_format)
                ...
                sheet.write(
                    row + 1, col + 8, data["grand_total"]["diff0_sum"], total_num_format
                )
                sheet.write(
                    row + 1, col + 9, data["grand_total"]["diff1_sum"], total_num_format
                )
                sheet.write(
                    row + 1,
                    col + 10,
