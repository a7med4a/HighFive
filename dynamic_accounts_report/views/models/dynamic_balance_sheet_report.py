    ...
    def get_xlsx_report(self, data, response, report_name, report_action):
        ...
        if data:
            if (
                ...
                for datas in data["datas"]:
                    sheet.write(
                        row, col + 1, datas["expense_depreciation"][1], txt_name
                    )
                    col += 1
                index = 0
                for datas in data["datas"]:
                ...
                for datas in data["datas"]:
                    sheet.write(
                        row, col + 1, datas["total_current_asset"], side_heading_sub
                    )
                    col += 1
                row += 1
                col = 0
                ...
                for datas in data["datas"]:
                    sheet.write(
                        row, col + 1, datas["total_current_liability"], side_heading_sub
                    )
                    col += 1
                col = 0
                row += 1
                ...
                for datas in data["datas"]:
                    sheet.write(
                        row, col + 1, datas["liability_non_current"][1], txt_name
                    )
                    col += 1
                index = 0
                for datas in data["datas"]:
                ...
                for datas in data["datas"]:
                    sheet.write(
                        row, col + 1, datas["total_liability"], side_heading_sub
                    )
                    col += 1
                col = 0
                row += 1
