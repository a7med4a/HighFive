...
class ResConfigSettings(models.TransientModel):
    ...
    def _get_light_color_values(self):
        return self.env["web_editor.assets"].get_color_variables_values(
            self.COLOR_ASSET_LIGHT_URL, self.COLOR_BUNDLE_LIGHT_NAME, self.COLOR_FIELDS
        )

    def _get_dark_color_values(self):
        return self.env["web_editor.assets"].get_color_variables_values(
            self.COLOR_ASSET_DARK_URL, self.COLOR_BUNDLE_DARK_NAME, self.COLOR_FIELDS
        )
    ...
    def _replace_light_color_values(self):
        ...
        return self.env["web_editor.assets"].replace_color_variables_values(
            self.COLOR_ASSET_LIGHT_URL, self.COLOR_BUNDLE_LIGHT_NAME, variables
        )
    ...
    def _replace_dark_color_values(self):
        ...
        return self.env["web_editor.assets"].replace_color_variables_values(
            self.COLOR_ASSET_DARK_URL, self.COLOR_BUNDLE_DARK_NAME, variables
        )
